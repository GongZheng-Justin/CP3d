...
#define DECOMP_TRANSPOSE_Z2X1 6
  ...
  public::decomp_2d_init,decomp_2d_finalize,decomp_info_init,myallocate,    &
          ...
          decomp_2d_write_plane,decomp_2d_write_every,update_halo,sum_halo, &
...
contains
  ...
  !^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^80^^^^^^^^90
  subroutine decomp_2d_write_plane(ipencil,var,iplane,n,filename,opt_decomp); implicit none
    ...
    if(iplane==1)then
      ...
      if(ierr/=0) call decomp_2d_abort(13, 'decomp_2d_write_plane-allocate wrong-1')
      IF(ipencil==1)THEN
      ...
      ELSEIF(ipencil==2)then
        ...
        if(ierr/=0) call decomp_2d_abort(13, 'decomp_2d_write_plane-allocate wrong-2')
      ...
      ELSE
        ...
        if(ierr/=0) call decomp_2d_abort(13, 'decomp_2d_write_plane-allocate wrong-3')
    ...
    elseif(iplane==2) then
      ...
      if(ierr/=0) call decomp_2d_abort(13, 'decomp_2d_write_plane-allocate wrong-4')
      IF(ipencil==2)THEN
      ...
      ELSE
        ...
        if(ierr/=0) call decomp_2d_abort(13, 'decomp_2d_write_plane-allocate wrong-5')
        if(ipencil==1)then
      ...
      IF(ipencil==1) THEN
        ...
        if(ierr/=0) call decomp_2d_abort(13, 'decomp_2d_write_plane-allocate wrong-6')
        allocate(wk3d(decomp%z2sz(1),decomp%z2sz(2),decomp%z2sz(3)),stat=ierr)
        if(ierr/=0) call decomp_2d_abort(13, 'decomp_2d_write_plane-allocate wrong-7')
      ...
      ELSEIF(ipencil==2) THEN
        ...
        if(ierr/=0) call decomp_2d_abort(13, 'decomp_2d_write_plane-allocate wrong-8')
        allocate(wk3d(decomp%z1sz(1),decomp%z1sz(2),decomp%z1sz(3)),stat=ierr)
        if(ierr/=0) call decomp_2d_abort(13, 'decomp_2d_write_plane-allocate wrong-9')
      ...
      ELSE
        allocate(wk2d(decomp%z1sz(1),decomp%z1sz(2),1),stat=ierr)
        if(ierr/=0) call decomp_2d_abort(13, 'decomp_2d_write_plane-allocate wrong-10')
        do j=1,decomp%z1sz(2)
          do i=1,decomp%z1sz(1) 
