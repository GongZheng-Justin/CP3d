#include "definitions_inc.f90"
  ...
  ! clcCosImagX
  !^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^80^^^^^^^^90
  subroutine clcCosImagX(arrx1,arrx2,m1,m2); implicit none
  ...
  ! clcCosImagZ
  !^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^80^^^^^^^^90
  subroutine clcCosImagZ(arrz1,arrz2,m1,m2); implicit none
    integer,intent(in)::m1,m2
  ...
  ! transform_uy
  !^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^80^^^^^^^^90
  subroutine transform_uy(uyIn,uyOut); implicit none
  ...
  ! clcEnergySpectraX
  !^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^80^^^^^^^^90
  subroutine clcEnergySpectraX(arrx,m); implicit none
    integer,intent(in)::m
  ...
  ! clcCospectraX
  !^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^80^^^^^^^^90
  subroutine clcCospectraX(arrx1,arrx2,m); implicit none
    integer,intent(in)::m
    real(RK),dimension(x1size(1),x1size(2),x1size(3)),intent(in)::arrx1,arrx2
  ...
  ! clcEnergySpectraZ
  !^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^80^^^^^^^^90
  subroutine clcEnergySpectraZ(arrz,m); implicit none
    integer,intent(in)::m
  ...
  ! clcCospectraZ
  !^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^80^^^^^^^^90
  subroutine clcCospectraZ(arrz1,arrz2,m); implicit none
    integer,intent(in)::m
    real(RK),dimension(z1size(1),z1size(2),z1size(3)),intent(in)::arrz1,arrz2
  ...
  ! clcLTS_x
  !^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^80^^^^^^^^90  
  subroutine clcLTS_x(arrx1,arrx2,ArrTemp,n1,n2,n3); implicit none
  ...
  ! clcLTS_z
  !^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^80^^^^^^^^90
  subroutine clcLTS_z(arrz1,arrz2,ArrTemp,n1,n2,n3); implicit none
    integer,intent(in)::n1,n2,n3
  ...
  ! clcSpectraAndLCSR2D
  !^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^80^^^^^^^^90
  subroutine clcSpectraAndLCSR2D(ArrIN,m1,m2); implicit none
    integer,intent(in)::m1,m2
  ...
  !^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^80^^^^^^^^90
  subroutine clcSpecAndLCSR2DFrom1D(arrx,m1,m2); implicit none
    integer,intent(in)::m1,m2
    real(RK),dimension(x1size(1),x1size(2),x1size(3)),intent(in)::arrx
  ...
  ! clcCosSpectra2D
  !^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^80^^^^^^^^90
  subroutine clcCosSpectra2D(ArrIN1,ArrIN2,m,IsSymmetry); implicit none
    integer,intent(in)::m
