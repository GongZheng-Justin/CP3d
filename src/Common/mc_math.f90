...
contains
  ...
  !^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^80^^^^^^^^90
  subroutine SymmetricMatrixEigen3(Mat, EigenValue, EigenVector, EigenErr); implicit none
  ...
  CONTAINS
    ...
    !^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
    subroutine NISymmetricEigen3(); implicit none
    ...
    !^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
    subroutine ItSymmetricEigen3(); implicit none
    ...
    !=======================================
    subroutine NormalizeEigen(); implicit none
    ...
    !=======================================
    subroutine clc_EigenError(EigenError); implicit none
    ...
    !=======================================
    subroutine ClcEigenVec0(eval1, evec1); implicit none
    ...
    !=======================================
    subroutine ClcEigenVec1(evec1, eval2, evec2); implicit none
    ...
    !=======================================
    function Vector3Cross(u,v) result(VecOut); implicit none
