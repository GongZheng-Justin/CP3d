...
module mc_TypeDef
  ...
  interface operator(+)
    module procedure real3_add1, real3_add2, real3_add3
    module procedure real3_add_real4, real4_add_real3
  end interface

  interface operator(-)
    module procedure real3_sub, real4_sub
  end interface
...
contains
  ...
  !^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^80^^^^^^^^90
  pure function int2str(i,n) result(ch); implicit none
    integer,intent(in)::i,n
    character(len=n)::ch
    character(len=:),allocatable::strFmt
    character(len=2)::n_str
    write(n_str, '(I2.2)') n
    strFmt = '(I'//n_str//'.'//n_str//')'
    write(ch, strFmt) i
  ...
  ! integer number to string
  !^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^80^^^^^^^^90
  character(64) function num2strI(i); implicit none
    integer,intent(in) :: i
    character(64):: ch
  ...
  !^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^80^^^^^^^^90
  character(64) function num2strR4(i); implicit none
    real(4), intent(in) :: i
    character(64):: ch
  ...
  !^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^80^^^^^^^^90
  character(64) function num2strR8(i); implicit none
    real(8),intent(in)::i
    character(64)::ch
  ...
  !^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^80^^^^^^^^90
  character(64) function num2strInt3(i); implicit none
  ...
  ! Vector1 + Vector2 
  !^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^80^^^^^^^^90  
  function real3_add1(p1,p2) result(p3); implicit none
  ...
  ! Vector + Scalar
  !^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^80^^^^^^^^90
  function real3_add2(p1,v) result(p3); implicit none
  ...
  ! Scalar + Vector
  !^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^80^^^^^^^^90
  function real3_add3(v,p1) result(p3); implicit none
    real(RK),intent(in)::v
    type(real3),intent(in)::p1
    type(real3)::p3
    p3= real3(p1%x+v, p1%y+v , p1%z+v) 
  ...
  ! Vector + LongVector
  !^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^80^^^^^^^^90
  function real3_add_real4(p1,p2) result(p3); implicit none
    type(real3),intent(in)::p1
  ...
  ! LongVector + Vector
  !^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^80^^^^^^^^90   
  function real4_add_real3(p1,p2) result(p3); implicit none
  ...
  ! Vector1 - Vector2
  !^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^80^^^^^^^^90    
  function real3_sub(p1,p2) result(p3); implicit none
    type(real3),intent(in)::p1,p2
    type(real3)::p3
    p3 = real3(p1%x-p2%x, p1%y-p2%y, p1%z-p2%z) 
  ...
  ! real3_prod1
  !^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^80^^^^^^^^90 
  function real3_prod1(p1,p2) result(p3); implicit none
    type(real3),intent(in)::p1,p2
    type(real3)::p3
    p3 = real3(p1%x*p2%x, p1%y*p2%y, p1%z*p2%z)
  ...
  ! real3_prod2
  !^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^80^^^^^^^^90
  function real3_prod2(p1,v) result(p3); implicit none
    type(real3),intent(in)::p1
    real(RK),intent(in)::v
    type(real3)::p3
    p3 = real3( p1%x*v, p1%y*v, p1%z*v) 
  ...
  ! real3_prod3
  !^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^80^^^^^^^^90
  function real3_prod3(v,p1) result(p3); implicit none
    type(real3),intent(in)::p1
    real(RK),intent(in)::v
    type(real3)::p3
    p3 = real3(p1%x*v, p1%y*v, p1%z*v) 
  ...
  ! real3_real4
  !^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^80^^^^^^^^90
  subroutine real3_real4(x,y); implicit none
  ...
  ! real4_real3
  !^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^80^^^^^^^^90    
  subroutine real4_real3(x,y); implicit none
  ...
  ! real3_array3
  !^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^80^^^^^^^^90
  subroutine real3_array3(x,y); implicit none
    type(real3),intent(out)::x
  ...
  ! real3_dotProd
  !^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^80^^^^^^^^90    
  function real3_dotProd(p1,p2) result(v); implicit none
    type(real3),intent(in)::p1,p2
    real(RK)::v
  ...
  ! real3_CrossProd
  !^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^80^^^^^^^^90
  function real3_CrossProd(u,v) result(p); implicit none
  ...
  ! real3_dist
  !^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^80^^^^^^^^90    
  function real3_dist(p1,p2) result(dist); implicit none
    type(real3),intent(in):: p1,p2
    real(RK)::dist
    dist = norm(p1-p2)
  ...
  ! real3_nv
  !^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^80^^^^^^^^90    
  function real3_nv(p1,p2) result(nv); implicit none
    type(real3),intent(in)::p1,p2
    type(real3)::nv
    type(real3)::s
    real(RK)::normv
  ...
  ! real3_norm
  !^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^80^^^^^^^^90    
  function real3_norm(p1) result(norm); implicit none
    type(real3),intent(in):: p1
    real(RK)::norm
  ...
  ! real4_sub
  !^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^80^^^^^^^^90        
  function real4_sub(p1, p2) result(p3); implicit none
  ...
  ! real4_ovlp
  !^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^80^^^^^^^^90
  function real4_ovlp(p1, p2) result(ovlp); implicit none
    type(real4),intent(in):: p1, p2
    real(RK)::ovlp
  ...
  ! real4_dist
  !^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^80^^^^^^^^90
  function real4_dist(p1, p2) result(dist); implicit none
    type(real4),intent(in):: p1, p2
    real(RK) dist
    dist = norm(p1-p2)
  ...
  ! real4_nv
  !^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^80^^^^^^^^90    
  function real4_nv(p1, p2) result(nv); implicit none
    type(real4),intent(in):: p1, p2
    type(real3)::nv,s
    real(RK)::normv
  ...
  ! real4_norm
  !^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^80^^^^^^^^90    
  function real4_norm(p1) result(norm); implicit none
    type(real4),intent(in):: p1
    real(RK)::norm
    norm = sqrt(p1%x*p1%x + p1%y*p1%y + p1%z*p1%z)
