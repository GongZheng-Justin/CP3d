...
contains
  ...
  subroutine PIO_RestartCL(this)
    ...
    allocate(TanDel_Un(DEM_Opt%ncvAllowed))
    allocate(CntctVec(DEM_Opt%ncvAllowed))
  ...
  subroutine PIO_Write_Restart(this,itime)
    ...
    integer::pid,i,j,k,nlocal,bgn_ind,prank,nreal3,rsize
    ...
    allocate(CntctVec(2*DEM_Opt%ncvAllowed))
