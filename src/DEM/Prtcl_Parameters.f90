module Prtcl_Parameters
  ...
  type DEMS_Options
    ...
    ! for monosize particles, ncvAllowed=12. A particle can contact with NO MORE THAN 12 neighbor particles.
    integer:: ncvAllowed=24 
...
contains
  ...
  subroutine DO_ReadDEMOption(this, chFile)
    ...
    integer::numPrtcl_Type,numWall_type,ncvAllowed,CntctList_Size,CS_numlvls,nUnitFile,ierror
    ...
    NAMELIST /DEMOptions/ RestartFlag,numPrtcl,numPrtclFix,gravity,CS_Method,CF_Type,PI_Method,PRI_Method,        &
                          numPrtcl_Type,numWall_type,CS_numlvls,ncvAllowed,CntctList_Size,Wall_max_update_iter,   &
                          RunName, Wall_neighbor_ratio,ResultsDir,RestartDir,Geom_Dir,Cmd_LFile_Freq,LF_file_lvl, &
    ...
    this%ncvAllowed = min(max(ncvAllowed,12), 1000)
