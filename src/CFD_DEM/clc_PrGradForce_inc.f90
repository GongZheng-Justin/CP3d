...
subroutine clc_PrGradForce(pressure,RatioYp_interp,RatioYc_interp); implicit none
  ...
  integer::ic,jc,kc,im,jm,km,id,jd,kd,pid,itype,i,j,k,nlocal
  ...
  call update_halo(dpdx, mb1, hi_px_interp)
  ...
  call update_halo(dpdz, mb1, hi_pz_interp)
