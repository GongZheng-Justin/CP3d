...
! clc_BassetForce
!^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^80^^^^^^^^90
subroutine clc_BassetForce(); implicit none
  ...
  sqrt_dt= sqrt(dt) 
  BassetCoe= 6.0_RK*FluidDensity*sqrt(PI*xnu)/dt
...
! clc_TailCoeBasset
!^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^80^^^^^^^^90
subroutine clc_TailCoeBasset(); implicit none
...
! clc_muCoeBasset
!^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^80^^^^^^^^90
function clc_muCoeBasset(nc) result(muCoeBasset); implicit none
  ...
  rn1=0.0_RK; rn2=0.0_RK; rn3=0.0_RK; rn4=0.0_RK; rn5=0.0_RK
