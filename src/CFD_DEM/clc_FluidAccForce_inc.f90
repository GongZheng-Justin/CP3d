...
subroutine clc_FluidAccForce(ux,uy,uz,RatioYp_interp,RatioYc_interp); implicit none
  ...
  DO pid=1,nlocal
    ...
    FluidAccForce      = (massFeff/dt)*(Vfluid-VfluidOld)
  ...
  dudx=0.0_RK; dudy=0.0_RK; dudz=0.0_RK
  ...
  call update_halo(dudz, mb1, hi_dudz_interp)
  ...
  dvdx=0.0_RK; dvdy=0.0_RK; dvdz=0.0_RK
  ...
  call update_halo(dvdx, mb1, hi_dvdx_interp)
  ...
  call update_halo(dvdz, mb1, hi_dvdz_interp)
  ...
  dwdx=0.0_RK; dwdy=0.0_RK; dwdz=0.0_RK
  ...
  call update_halo(dwdx, mb1, hi_dwdx_interp)
