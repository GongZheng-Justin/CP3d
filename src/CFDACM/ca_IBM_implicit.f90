module ca_IBM_implicit
  ...
  integer,parameter::THIS_PROC_XP= 7
  integer,parameter::THIS_PROC_XM= 8
  integer,parameter::THIS_PROC_ZP= 9
  integer,parameter::THIS_PROC_ZM=10
...
#include "ca_IBM_common_inc.f90"
  ...
  !******************************************************************
  subroutine InterpolationIBM_imp(uxStar,uyStar,uzStar)
    implicit none
  ...
  subroutine unpack_IBM_recover_imp(buf_recv,nrecv,nlocalp,dir)
    ...
    DO i=1,nrecv
      ...
      itype= int(buf_recv(m)+0.2);       m=m+1   ! 04
