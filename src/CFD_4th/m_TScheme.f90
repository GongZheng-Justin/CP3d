...
contains    
  ...
  subroutine InitTimeScheme()
    ...
    CASE(-1)
      am2cScCN(1)= eight*rdyc(1)/( dyc(1)+2.0_RK*dyc(2) )
      ap2cScCN(1)=  four*rdyc(2)/( dyc(1)+2.0_RK*dyc(2) )
      ac2cScCN(1)= -(eight*rdyc(1)+four*rdyc(2))/( dyc(1)+2.0_RK*dyc(2) )
    CASE(-2)
    ...
    CASE(-1)
      am2cScCN(nyc)=   four*rdyc(nyc)/( dyc(nyp)+2.0_RK*dyc(nyc) )
      ap2cScCN(nyc)=  eight*rdyc(nyp)/( dyc(nyp)+2.0_RK*dyc(nyc) )
      ac2cScCN(nyc)=-(eight*rdyc(nyp)+four*rdyc(nyc))/( dyc(nyp)+2.0_RK*dyc(nyc) )
    CASE(-2)
