...
contains
  ...
  subroutine InitPoissonSolver(prsrc,prphiHalo)
    ...
    ! locals
    real(RK)::wa1,wa3,best_time,t1,t2
    ...
    do i=1,nxc
      ...
      WaveNumX(i)=rdx2/288.0_RK*(cos(three*wa1)-54.0_RK*cos(two*wa1)+783.0_RK*cos(wa1)-730.0_RK)
    enddo
    do k=1,nzc
      wa3= twopi*real(k-1,RK)/real(nzc,RK)
      WaveNumZ(k)=rdz2/288.0_RK*(cos(three*wa3)-54.0_RK*cos(two*wa3)+783.0_RK*cos(wa3)-730.0_RK)
    enddo
