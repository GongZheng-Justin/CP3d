...
#ifdef CFDDEM
          convEd1= -h11-h12-h13 + xnu*dcq123 + gravity(1)+0.5_RK*(FpForce_x(ic,jc,kc)+FpForce_x(im,jc,kc))
#elif CFDLPT_TwoWay 
    ...
    DO kc=y1start(3),y1end(3)
      ...
      do jc=y1start(2),y1end(2)
        ...
        do ic=y1start(1),y1end(1)
          ...
          s1tot=s1tot+ux(ic,jc,kc)*s1totCoe         
#ifdef CFDDEM
          convEd1= -h11-h12-h13 +sgs1+sgs2+sgs3+dcq123+gravity(1)+0.5_RK*(FpForce_x(ic,jc,kc)+FpForce_x(im,jc,kc))
#elif CFDLPT_TwoWay
    ...
    DO kc=y1start(3),y1end(3)
      ...
      do jc=y1start(2),y1end(2)
        ...
        do ic=y1start(1),y1end(1)
          ...
          gradp2= (pressure(ic,jc,kc)-pressure(ic,jm,kc))*sucac
#ifdef CFDDEM
          convEd2= -h21-h22-h23+ sgs1+sgs2+sgs3 +dcq123+ gravity(2)+0.5_RK*(FpForce_y(ic,jc,kc)+FpForce_y(ic,jm,kc))
#elif CFDLPT_TwoWay         
    ...
    DO kc=y1start(3),y1end(3)
      ...
      do jc=y1start(2),y1end(2)
        ...
        do ic=y1start(1),y1end(1)
          ...
          gradp3= (pressure(ic,jc,kc)-pressure(ic,jc,km))*rdz 
#ifdef CFDDEM
          convEd3=-h31-h32-h33+sgs1+sgs2+sgs3+dcq123+gravity(3)+0.5_RK*(FpForce_z(ic,jc,kc)+FpForce_z(ic,jc,km))
#elif CFDLPT_TwoWay
