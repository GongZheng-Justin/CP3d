#include "definitions_inc.f90"
  ...
  ! clcRhsX_FEXP
  !^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^80^^^^^^^^90
  subroutine  clcRhsX_FEXP(ux,uy,uz,RhsX,HistXold,pressure); implicit none
  ...
  ! clcRhsY_FEXP
  !^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^80^^^^^^^^90    
  subroutine  clcRhsY_FEXP(ux,uy,uz,RhsY,HistYold,pressure); implicit none
    real(RK),dimension(mb1%xmm:mb1%xpm,mb1%ymm:mb1%ypm,mb1%zmm:mb1%zpm),intent(in)::ux,uy,uz,pressure
  ...
  ! clcRhsZ_FEXP
  !^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^80^^^^^^^^90 
  subroutine  clcRhsZ_FEXP(ux,uy,uz,RhsZ,HistZold,pressure); implicit none
    real(RK),dimension(mb1%xmm:mb1%xpm,mb1%ymm:mb1%ypm,mb1%zmm:mb1%zpm),intent(in)::ux,uy,uz,pressure
  ...
  ! clcU1Hat_FEXP
  !^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^80^^^^^^^^90    
  subroutine clcU1Hat_FEXP(ux,RhsX); implicit none
  ...
  ! clcU2Hat_FEXP
  !^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^80^^^^^^^^90  
  subroutine clcU2Hat_FEXP(uy,RhsY); implicit none
  ...
  ! clcU3Hat_FEXP
  !^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^80^^^^^^^^90  
  subroutine clcU3Hat_FEXP(uz,RhsZ); implicit none
  ...
  ! PressureUpdate_FEXP
  !^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^80^^^^^^^^90
  subroutine PressureUpdate_FEXP(pressure, prphiHalo); implicit none
