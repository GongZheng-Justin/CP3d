...
do
  cp ./Input/CFDACM/PrtclRestitution/SpheresCoord.Case"$loop" ./ACM/Restart/SpheresCoord.dat
  $appStr -n $nproc ./channelACM ./Input/CFDACM/PrtclRestitution/PrtclRestitutionCase"$loop".cfd ./Input/CFDACM/PrtclRestitution/PrtclRestitutionCase"$loop".acm $p_row $p_col
done
