...
## How to cite **CP3d**?
* Z. Gong, Z. Wu, C. An, B. Zhang, X. Fu, CP3d: A comprehensive Euler-Lagrange solver for direct numerical simulation of particle-laden flows, Submitted to Computer Physics Communications.   
