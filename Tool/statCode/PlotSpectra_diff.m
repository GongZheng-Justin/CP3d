...
function PlotSpectra_diff
  ...
  [SpecData1,~,~,~]=GetSpecData(SpecFileDir);
  SpecDataDir='../../StatOut/OC0550L/';
  SpecFileDir=[SpecDataDir,'spec',DirStr,'_',VarStr,'.txt'];
  [SpecData2,yplus,lamda,Retau]=GetSpecData(SpecFileDir);
  SpecData=SpecData2-SpecData1;
...
146	10	0;
  ...
  colormap(color(1:20,:)); %get current colormap
  caxis([-0.2,0.2]);set(ch,'YLim',[-0.2,0.2]);
